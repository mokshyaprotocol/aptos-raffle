...
module raffle::raffle
{
    ...
    {
        raffles: Table<String, address>, //initiated while creating the module contains the 
                                         //appended name of collection and token and raffle
                                         //game_address
    }
    ...
    )acquires GameMap,Raffle,Player
    {
        ...
        //player verification
        assert!(exists<GameMap>(player_addr),ENO_NOT_PLAYER);
